...
public class TranOolongTea
{
    ...
    public TranOolongTea(int a, int b)
    {
        x = a;
        y = b;
        diam = 30;
        ...
        imgIcons[0] = new ImageIcon(TranPlayer.class.getResource("OolongTea.png"));
        imgIcons[1] = new ImageIcon(TranPlayer.class.getResource("ReverseOolongTea.png"));
    }
